...
/*   Updated: 2025/02/20 17:50:44 by cpoulain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_INVALID_RGB_DATA		"%s%s:\t: Invalid rgb data.%s\n"
# define ERR_FATAL_ALLOC			"%s%s:\t: Could not allocate memory.%s\n"
# define ERR_FILE_IS_DIR			"%s%s:\t: File is a directory.%s\n"
